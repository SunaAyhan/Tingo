...
if(keyboard_check(vk_left)and tilemap_get_at_pixel(map_id, x-3, y) != 0 and x>=0)
{
	x-=3
...
if(keyboard_check(vk_right) and tilemap_get_at_pixel(map_id, x+3, y) != 0  and x<=room_width)
{
	x+=3
	image_xscale=-sprite_index_normal
...
if(keyboard_check(vk_up)and tilemap_get_at_pixel(map_id, x, y-3) != 0 and y>=0 )
{
	y-=3
	image_xscale=sprite_index_normal
...
if(keyboard_check(vk_down)and tilemap_get_at_pixel(map_id, x, y+3) != 0 and y<= room_height)
{
	y+=3
	image_xscale=sprite_index_normal
