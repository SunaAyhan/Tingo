...
if(isDragging or lockedPos!=0){
	...
	if((hold and v_pos>-10) or lockedPos ==1 ){
		global.yurumehizix = (v_pos / mouse_radius) * global.Max_Speed; 
		keyboard_key_press(vk_left);
		keyboard_key_release(vk_right);
	}else if((hold and v_pos<10) or lockedPos ==3 ){
		global.yurumehizix = (v_pos / -mouse_radius) * global.Max_Speed; 
	...
	if((hold and h_pos>-10) or lockedPos ==2 ){
		global.yurumehiziy = (h_pos / mouse_radius) * global.Max_Speed; 
		keyboard_key_press(vk_up);
		keyboard_key_release(vk_down);
	}else if((hold and h_pos<10) or lockedPos ==4 ){
		global.yurumehiziy = (h_pos / -mouse_radius) * global.Max_Speed;
